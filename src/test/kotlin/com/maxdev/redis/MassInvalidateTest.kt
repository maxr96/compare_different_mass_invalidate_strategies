...
class MassInvalidateTest {
    ...
    fun testHashApproach() {
        ...
        val scanCommand = ds.key()
        val timeToRemoveKeys = measureTimeMillis {
            val keys = scanCommand.unlink("company_1000")
        }
        println("Time to find and remove keys: $timeToRemoveKeys")
        val timeToGetAndSetKeys = measureNanoTime {
    ...
    fun testSetApproach() {
        ...
        val timeToRemoveKeys = measureTimeMillis {
            ...
            val keys = scanCommand.unlink(*values.toTypedArray())
        }
        println("Time to find and remove keys: $timeToRemoveKeys")
        val timeToGetAndSetKeys = measureNanoTime {
...
// Naiv total allocated: 1431450736 = 1431.4 Mbytes

// Hash
//Time to fill key space: 81824
//Time to find and remove keys: 1
//Time to get and set keys: 0
...
// Set
//Time to fill key space: 170324
//Time to find and remove keys: 7
//Time to get and set keys: 1
...
// Naive
//Time to fill key space: 81647
//Time to find and remove keys: 317
//Time to get and set keys: 0
